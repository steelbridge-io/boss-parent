...
function roots_scripts() {
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, 'b4d0f1f04cf648410a8ef147cc589427');
	wp_enqueue_style('stylesheet', get_template_directory_uri() . '/style.css', false);
	wp_enqueue_style('sass', get_template_directory_uri() . '/sass.css', false);
  wp_enqueue_style('datatables','https://cdn.datatables.net/1.10.11/css/jquery.dataTables.min.css');
  ...
  wp_enqueue_script('hoverfix',get_template_directory_uri() . '/assets/js/hoverfix.js');
  wp_enqueue_script('hoverintent',get_template_directory_uri() . '/assets/js/hoverintent.js');
